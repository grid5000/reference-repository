    ...
    4.times do |i|
      node "#{cluster_uid}-#{i+1}" do |node_uid|
        ...
        },
        {
          ...
          :hwid             => lookup('graphite_manual', node_uid, 'network_interfaces', 'ib0', 'hwid'),
          :switch           => "sgraoullyib",
          :ib_switch_card   => lookup('graphite_manual', node_uid, 'network_interfaces', 'ib0', 'line_card'),
          :ib_switch_card_pos => lookup('graphite_manual', node_uid, 'network_interfaces', 'ib0', 'position'),
        },
        {
          :interface => 'Ethernet',
          :rate => 100.M,
