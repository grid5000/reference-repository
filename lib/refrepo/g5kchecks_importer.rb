...
INTERFACE_ORDER = %w[eth0 eth1 eth2 eth3 eth4 eth5 eth6 eth7 ib0 ib1 ib2 ib3 ib4 ib5 ib6 ib7 ibs1 ibs4 ibp130s0 bmc
                     eno1 eno2 eno3 eno4 eno1np0 eno2np1 enp1s0f0np0 ens4f0 ens4f1 ens5f0 ens5f1 ens10f0np0 ens10f1np1 ib0.8100]
...
def g5kchecks_importer(sourcedir)
  ...
  list_of_yaml_files.each do |filename|
    ...
    remaped_net_names = []
    hash['network_adapters'].each do |net_name, net_adapter|
