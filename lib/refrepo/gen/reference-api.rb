    ...
    site.fetch("clusters", []).sort.each do |cluster_uid, cluster|
      ...
      cluster["nodes"].each do |node_uid, node|# _sort_by_node_uid
        begin
          ...
          node["network_adapters"] = node["network_adapters"].sort_by_array(["eth0", "eth1", "eth2", "eth3", "eth4", "eth5", "eth6", "ib0.8100", "ib0", "ib1", "ib2", "ib3","ibp12s0","ibp132s0","ibp139s0","bmc", "eno1", "eno2", "eno1np0", "eno2np1", "ens4f0", "ens4f1", "ens5f0", "ens5f1"]).values
