  ...
  global_hash["sites"].each do |site_uid, site|
    ...
    site.fetch("clusters", []).sort.each do |cluster_uid, cluster|
      ...
      cluster["nodes"].each do |node_uid, node|# _sort_by_node_uid
        ...
        node["network_adapters"] = node["network_adapters"].sort_by_array(["eth0", "eth1", "eth2", "eth3", "eth4", "eth5", "eth6", "ib0.8100", "ib0", "ib1", "ib2", "ib3", "ib4", "ib5", "ib6", "ib7", "ibs1","ibs3","ibs4","bmc", "eno1", "eno2", "eno1np0", "eno2np1", "ens4f0", "ens4f1", "ens5f0", "ens5f1", "ens10f0np0", "ens10f1np1", "fpga0", "fpga1"]).values
